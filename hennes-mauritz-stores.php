...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Energy management and savings of Hennes & Mauritz Stores</title>
          ...
          <div class="container">
              <div class="secondaryHeaderContent portfolioSecondaryHeader">
                 <a href="./portfolio.php"> <img src="./images/backButton.svg"/></a>
                  <h4>Energy management and savings of Hennes & Mauritz Stores</h4>
                  <p>Innovation And Inspired Living (I2L)</p>
              </div>
          </div>
      </section>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                  <ul class="slider-ul project-img-list">
                    <li class="slider-item"><img src="./images/h&m.jpg" /></li>
                  ...
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>Hennes & Mauritz AB;</span></h4>
                      <h4>Ended Jun, 2021</h4>
                  </div>
                  ...
                  <div class="individualPortfolioDes">
                    <p>
                        The Hennes & Mauritz AB (H&M) Group is a Swedish multinational clothing corporation.
                        H&M has over 50 stores in India. IDSPL provided energy management services in this
                        project using advanced data analytics techniques with the goal of achieving operational
                        energy savings in 11 retail stores across north, west, and south India.
                    </p>
                    <p>
                        Each store is approximately 2000 square meters in size and is located within shopping malls. IDSPL
                        examined the meter and sub-meter levels to identify energy uses in multiple stores by
                        area/floor and appliance level. Our data analytics toolkit provided a detailed visualization
                        of the energy system as well as opportunities for energy savings both during and after
                        work hours. Furthermore, the toolkit has revealed information about HVAC, lighting, and
                        other equipment such as UPS. It saved up to 14% of H&M stores' operational energy in
                        this project.
                    </p>
                  </div>
              </div>
          ...
          <div class="container">
            <div class="portfolionav">
                <div class="portfolionavList">
                  <a class="prev-link" href="leed-certification-of-un-house.php">
                    <h5><img src="./images/arrow-left.svg" alt=""> Previous Work</h5>
                    <h4>LEED Certification of UN House</h4>
                  </a>
                </div>
                <div class="portfolionavList">
                  <a class="next-link" href="symbiosis-international-university.php">
                    <h5>Next Work <img src="./images/arrow-right.svg" alt=""></h5>
                    <h4>2000-Watt Smart Cities (2000WSC) India rating of Symbiosis International University</h4>
                  </a>
                </div>
            </div>
          </div>
