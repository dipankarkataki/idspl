...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Energy Efficient Design & ECBC Compliance Support for DC Office</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Energy Efficient Design & ECBC Compliance Support for DC Office</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/dc-office.png" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Mysuru, Karnataka</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>Public Works Department, Karnataka;</span></h4>
                      <h4>Ended Spet, 2016</h4>
                  </div>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The project is an office building with basement and G+1 floor, located in a warm and humid climate.
                    ...
                    <div style="margin-top:30px;margin-bottom: 30px;">
                      ...
                      <ul style="margin-left: 30px; padding:4px;">
                        <li><a href="https://mysore.nic.in/en/department/dc-office-mysuru/"  target="_blank">Dc Office Mysore</a></li>
                      </ul>
                    </div>  
                  </div>
