...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Diesel Generator Monitoring System</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Diesel Generator Monitoring System</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/disel-generator.png" /></li>
                </ul>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The Diesel Generator Monitoring System is like a remote control to the DG-Set.
                        It gives customized alerts and reports, about the DG running hours, usage, and 
                        can also access to historical data. Other than accessing data from a central location,
                        it also helps in monitoring how much fuel was added or removed (and at what time) using fuel sensors.  
                      </p>
