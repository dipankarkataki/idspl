...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Smart Water Monitoring & Automation System</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Smart Water Monitoring & Automation System</h4>
                <p>Uncategorised</p>
            </div>
        </div>
      </section>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/smart-water-automatic-system.jpg" /></li>
                </ul>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The smart water monitoring and automation system helps in monitoring the water
                        levels for different tanks in the building from a single screen. It monitors water
                        meter and hydro pneumatic system. It gives custom analysis and reports instantly.
                        It also calculates and analyses the bore well running hours on a daily, monthly and annual basis. 
                      </p>
