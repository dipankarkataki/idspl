...
<html lang="en" dir="ltr">
  <head>
      ...
      <title>Portfolio - Climate and energy analysis support for Ireon SkyOn Club</title>
		   ...
		   <div class="col-sm-6">
             <nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
				...
				<!--<li class="breadcrumb-item active"> Sky On Club</li>-->
			  </ol>
			 </nav>
			</div>
			<div class="col-sm-6">
          ...
          <div class="container">
              <div class="secondaryHeaderContent portfolioSecondaryHeader">
                 <a href="./portfolio.php"> <img src="./images/backButton.svg"/></a>
                  <h4>Climate and energy analysis support for Ireon SkyOn Club</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                  <ul class="slider-ul project-img-list">
                    <li class="slider-item"><img src="./images/skyon-club1.jpg" /></li>
                    <li class="slider-item"><img src="./images/skyon-club2.jpg" /></li>
                    <li class="slider-item"><img src="./images/skyon-club3.jpg" /></li>
                    <li class="slider-item"><img src="./images/skyon-club4.jpg" /></li>
                  </ul>
                  ...
                  <div class="individualPortfolioDes">
                      <p>Ireo SkyOn is Part of Ireo City spread over 500 Acres. SkyOn Club is being built there. The project is still in progress. The work done by IDSPL includes climate analysis, sun path & sun eye analysis, radiation map analysis, building envelope analysis, and space analysis.</p>
                      <div style="margin-top:30px;margin-bottom: 30px;">
                        <h5 style="margin-bottom:10px;font-weight:600;">Relevant Links</h5>
                        <ul style="margin-left: 30px; padding:4px;">
                          <li><a href=https://www.ireoskyon.in/clubhouse"  target="_blank">Ireo Skyon Club</a></li>
                        </ul>
                      </div> 
                  </div>
              </div>
          ...
          <div class="container">
            <div class="portfolionav">
                <div class="portfolionavList">
                  <a class="prev-link" href="gn-studio.php">
                ...
                <div class="portfolionavList">
                  <a class="next-link" href="assotech-commercial-building.php">
                    <h5>Next Work <img src="./images/arrow-right.svg" alt=""></h5>
                    <h4>Assotech Commercial Building and Hotel Complex, Greater Noida, Uttar Pradesh</h4>
                  </a>
                </div>
            </div>
          </div>
