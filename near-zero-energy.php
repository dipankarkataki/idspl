...
<html lang="en" dir="ltr">
  <head>
      ...
      <title>Portfolio - Implementation of near zero energy retrofitting of united nations house in Delhi</title>
		   ...
		   <div class="col-sm-6">
             <nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
				...
				<!--<li class="breadcrumb-item active"> Implementation of near zero energy retrofitting of united nations house in Delhi</li>-->
			  </ol>
			 </nav>
			</div>
			<div class="col-sm-6">
          ...
          <div class="container">
              <div class="secondaryHeaderContent portfolioSecondaryHeader">
                 <a href="./portfolio.php"> <img src="./images/backButton.svg"/></a>
                  <h4>Implementation of near zero energy retrofitting of united nations house in Delhi</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                  <ul class="slider-ul project-img-list">
                    <li class="slider-item"><img src="./images/near-zero-energy1.jpg" /></li>
                    <li class="slider-item"><img src="./images/near-zero-energy2.jpg" /></li>
                  </ul>
                  <div class="individualPortfolioDes">
                      <p>The work involved the implementation of energy efficient strategies related to building envelope, lighting, air-conditioning, electrical systems and rooftop photovoltaic system. The baseline for the building will be developed by implementing an extensive monitoring campaign of electricity consumption by various end use and through hygro-thermal data logging.</p>
                      <p>The work also included the technical support for making the UN Annexe building (~600 m<sup>2</sup> built-up area) as net zero energy building. Dynamic energy simulation software was used to arrive at viable energy efficient strategies</p>
                  </div>
              </div>
          </div>
      </section>
          ...
          <div class="container">
            <div class="portfolionav">
                <div class="portfolionavList">
                  <a class="prev-link" href="development-guidelines-nigeria.php">
                    <h5><img src="./images/arrow-left.svg" alt=""> Previous Work</h5>
                    <h4>Development of guidelines on “Energy and Resource Efficiency Measures and Regulations for the Building Sector in Nigeria”
</h4>
                  </a>
                </div>
                <div class="portfolionavList">
                  <a class="next-link" href="baseline-scenario-energy-performance.php">
