...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Implementation of Energy Management Information System (EMIS) and Implementation of Building Energy Passport and ECBC Compliance tool.</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Implementation of Energy Management Information System (EMIS) and Implementation of Building Energy Passport and ECBC Compliance tool.</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  ...
                  <div class="hashtags">
                    <p>EMIS</p>
                    <p>Building Energy Passport</p>
                    <p>ECBC COmpliance Tool</p>
                    <p>Policy IMplementation</p>
                  </div>
                  <div class="individualPortfolioDes">
                      <p>
                        Implementation of Energy Management Information System (EMIS) 
                        and Implementation of Building Energy Passport and  ECBC Compliance tool. 
                      </p>
                      <p>
                        Description of actual services provided by your staff within the assignment:
                        <ul>
                            <li>Preparation of technical specifications for the Building Energy Passport – Energy Monitoring Systems (BEP-EMIS) and technical support for development and demonstration of the compliance tools.</li>
                            <li>Facilitate two international exposure visits on best practices exchange and adoption</li>
                            <li>Support architecture and engineering institutions to include building energy efficiency in their curriculum</li>
                            <li>Review of compendium of Energy Efficient Building Materials and Technologies (EEBM&T)</li>
                        </ul>
                      </p>
                    ...
                    <!-- <div style="margin-top:30px;margin-bottom: 30px;">
                      ...
                      <ul style="margin-left: 30px; padding:4px;">
                        <li><a href="https://www.py.gov.in"  target="_blank">Govt Of Puducherry</a></li>
                      </ul>
                    </div>   -->
                  </div>
