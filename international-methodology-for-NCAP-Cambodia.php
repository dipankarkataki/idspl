...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>International Methodology for NCAP Development and Emission Data Assessment for Cooling Sectors in Cambodia</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>International Methodology for NCAP Development and Emission Data Assessment for Cooling Sectors in Cambodia</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/cambodia.jpg" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Cambodia</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>UN ESCAP, Bangkok;</span></h4>
                      <h4>Ended Jul, 2021</h4>
                  </div>
                  ...
                  <div class="hashtags">
                    ...
                    <p>Cambodia</p>
                    <p>Policy</p>
                    <p>NCAP Development</p>
                  </div>
                  <div class="individualPortfolioDes">
                    <p>
                        Development of “International methodology for data assessment framework for developing National Cooling Action Plan (NCAP) for ASEAN countries”.
                        Cooling demand and GHG emission assessment across cooling sectors like building space cooling, mobile air-conditioners, food cold chain, healthcare cold chain and process cooling.
                        Contributed to the development of NCAP for Cambodia 
                    </p>
