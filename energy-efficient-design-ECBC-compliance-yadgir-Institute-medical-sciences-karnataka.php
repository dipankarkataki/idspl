...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Energy Efficient Design & ECBC Compliance Support for Yadgir Institute of Medical Sciences, Karnataka</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Energy Efficient Design & ECBC Compliance Support for Yadgir Institute of Medical Sciences, Karnataka</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/yadgir-institute.png" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Karnataka</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>Public Works Department, Karnataka;</span></h4>
                      <h4>Ended Dec, 2016</h4>
                  </div>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The Public Works Department (PWD), Karnataka have proposed the Yadgir Institute
                        of Medical Sciences an institutional building in Yadgir District of Karnataka.
                        The building has ground and three floors. The building comprises of various departments
                        in the medical sciences with laboratory facilities.IDSPL provided recommendations and implementation
                        of interventions to be adopted in the demonstration building to achieve ECBC compliance  related to
                        envelope optimisation, cooling load reduction, HVAC DBR peer review, Renewable energy systems,
                        building energy analysis etc.
