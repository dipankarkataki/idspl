...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Baseline Scenario for Energy Performance of Residential Buildings in the Cold Climatic Zone of India/title>
      ...
      <section class="individualPortfolio">
          <div class="container">
              <div class="individualPortfolioImage">
                  ...
                  <div class="individualPortfolioDetails">
                    <h4>Client : <span>Greentech Knowledge Solutions Private Limited;</span></h4>
                    <h4>Ended 2016</h4>
                  </div>
                  ...
                  <div class="hashtags">
                    ...
                    <p>Energy Performance Baseline</p>
                  </div>
                  <div class="individualPortfolioDes">
                    <p>
                        Implemented assignment on "Baseline Scenario for Energy Performance of
                        Residential Buildings in the Cold Climatic Zone of India" for Indo-Swiss
          ...
          <div class="container">
            <div class="portfolionav">
                <div class="portfolionavList">
                  <a class="prev-link" href="new-un-extension-office.php">
                ...
                <div class="portfolionavList">
                  <a class="next-link" href="establish-ecbc-cell-14states.php">
