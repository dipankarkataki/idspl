...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Chapter on "Sustainable Cooling for All" in "Global Status Report 2021 for Building and Construction"</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Chapter on "Sustainable Cooling for All" in "Global Status Report 2021 for Building and Construction"</h4>
                <p>Sustainable Cooling </p>
            </div>
        </div>
      </section>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/sustainable-cooling.jpg" /></li>
                  ...
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>International</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>UNEP, Paris;</span></h4>
                  ...
                  <div class="peopleInvolved">
                      ...
                      <ul>
                        ...
                        <li title="Anubha Ashitkar"><img src="./images/anu.jpg" alt="" class="img-circle" /></li>
                      </ul>
                  </div>
                  <div class="hashtags">
                    <p>Sustainable Cooling for All GlobalABC</p>
                    <p>GSR2021 for Building Construction</p>
                  </div>
                  <div class="individualPortfolioDes">
                    <p>In this project, UNEP wanted to publish Global Status Report on Buildings.
                        IDSPL contributed as a lead author for spotlight chapter on "Sustainable Cooling for
                        All" reflecting on avoid-Imrppove-Shift-Protect Approach for Sustainable Cooling, case
                        studies with sustainable cooling in building air conditioning, refrigeration and passive cooling 
                        solutions and international best practices and recommendations for buidling and construction sector stakeholders.
                        The report got published in the year 2021.
                    </p>
