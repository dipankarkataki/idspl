...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Energy Efficient Design Support for Fortis Hospital Building</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Energy Efficient Design Support for Fortis Hospital Building</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/fortis-hospital-1.jpg" /></li>
                  <li class="slider-item"><img src="./images/fortis-hospital-2.jpg" /></li>
                  <li class="slider-item"><img src="./images/fortis-hospital-3.png" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Ludhiana, Punjab</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>Aircon Engineers Pvt Ltd;</span></h4>
                      <h4>Ended 2016</h4>
                  </div>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The commercial building is a self -contained IT Park offering Office Space, Research and Tech Lab Spaces, Incubators, IT & ITES offices with access to facilities like Serviced Apartments, Recreation, Health, Entertainment and Shopping, etc.
                        IDSP provided technical consulting related to envelope optimisation, cooling load reduction, HVAC DBR peer review etc.
                      </p>

                    <div style="margin-top:30px;margin-bottom: 30px;">
                      <h5 style="margin-bottom:10px;font-weight:600;">Relevant Links</h5>
                      <ul style="margin-left: 30px; padding:4px;">
                        <li><a href="https://www.fortishealthcare.com/india/fortis-hospital-in-ludhiana-punjab?utm_source=google-gmb&utm_medium=gmb-seo-url&utm_campaign=fhl-gmb"  target="_blank">Fortis Hospital</a></li>
                      </ul>
                    </div>  
                  </div>
