...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Condensation analysis for selection of insulation materials for Leh airport, UT of Ladakh</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Condensation analysis for selection of insulation materials for Leh airport, UT of Ladakh</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                    <li class="slider-item"><img src="./images/EqUKxvdU8AMk6k9.jfif" /></li>
                    <li class="slider-item"><img src="./images/Screenshot 2023-02-08 170207.png" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Leh, Ladakh</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>U.P. Twiga Fiberglass Limited;</span></h4>
                      <h4>Ended August, 2022</h4>
                  </div>
                  ...
                  <div class="hashtags">
                    <p>Structural feasibility</p>
                    <p>energy efficiency</p>
                    <p>passive strategies</p>
                    <p>builidng envelope</p>
                  </div>
                  <div class="individualPortfolioDes">
                      <p>The feasibility of the insulation materials for the roof and wall construction of the Leh airport building was conducted using design builder software. The permiability of the vapour barrier was redefined to help the client select the correct insulation materials suitable for the building.</p>
