...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Develop training sessions, working aids, Training manuals etc.</title>
          ...
          <div class="container">
              <div class="secondaryHeaderContent portfolioSecondaryHeader">
                 <a href="./portfolio.php"> <img src="./images/backButton.svg"/></a>
                  <h4>Develop training sessions, working aids, Training manuals etc.</h4>
                  <p>Energy Efficient system</p>
              </div>
          </div>
      </section>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                  ...
                  <div class="individualPortfolioDes">
                    <p>
                        To develop training sessions, working aids, Training manuals, ToT manuals and other
                        required material, as per the topic, controlling per capita "Fossil fuel consumption in the
                        city".
                    </p>
                    <p>
                        Developing 3 training session, Presentation, Training manuals, ToT manuals other
                        required material, as per the topics "energy efficient water supply system”.
                    </p>
                  </div>
              </div>
          </div>
          ...
          <div class="container">
            <div class="portfolionav">
                <div class="portfolionavList">
                  <a class="prev-link" href="training-sessions.php">
                    <h5><img src="./images/arrow-left.svg" alt=""> Previous Work</h5>
                    <h4>Develop training sessions, working aids, Training manuals etc.</h4>
                  </a>
                </div>
                <div class="portfolionavList">
                  <a class="next-link" href="leed-certification-of-un-house.php">
