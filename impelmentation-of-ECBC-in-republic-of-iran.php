...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Impelmentation of Energy Conservation Building Code and Energy Management Information System in the Republic of Iran</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Impelmentation of Energy Conservation Building Code and Energy Management Information System in the Republic of Iran</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/ecbc-undp-iran-1.jpg" /></li>
                  <li class="slider-item"><img src="./images/ecbc-undp-iran-2.jpg" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Tehran</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>UNDP Iran;</span></h4>
                      <h4>Ended 2019</h4>
                  </div>
                  ...
                  <div class="hashtags">
                    <p>Iran</p>
                    <p>policy</p>
                    <p>energy efficiency codes</p>
                    <p>building codes</p>
                  </div>
                  <div class="individualPortfolioDes">
                    <p>
                        The project focuses on development of policy reforms for improving energy and resource efficiency of built environment in 
                        the Republic of Iran. The components of the project included developing Building Energy Efficiency Codes and the 
                        implementation mechanisms such as Energy Monitoring and Information Systems for Commercial and Residential buildings 
                        in Iran.
                    </p>
                    <p> Description of actual services provided by your staff within the assignment:
                        <ul>
                            <li>Report on stakeholders mapping and functional requirements.</li>
                            <li>Functional specifications for EMIS on BEP/EPC development procedures requirements.</li>
                            <li>TPA accreditation system report</li>
                            <li>Report on National software selection</li>
                            <li>Report on ECBC implementation system</li>
                            <li>Report on tender evaluation</li>
                            <li>Develop operational guidelines for EMIS use</li>
                            <li>Training program for users of EMIS</li>
                        </ul>
                    </p>
                    ...
                    <div style="margin-top:30px;margin-bottom: 30px;">
                      ...
                      <ul style="margin-left: 30px; padding:4px;">
                        <li><a href="https://www.undp.org/iran/projects/policy-reforms-and-market-transformation-energy-efficient-buildings-sector-ir-iran"  target="_blank">ECBC UNDP IRAN</a></li>
                      </ul>
                    </div>  
                  </div>
