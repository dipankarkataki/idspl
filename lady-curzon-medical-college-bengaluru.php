...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Energy Efficient Design & ECBC Compliance Support for Bowring and Lady Curzon Medical College, Bengaluru</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Energy Efficient Design & ECBC Compliance Support for Bowring and Lady Curzon Medical College, Bengaluru</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/lady-curzon-medical-college-bengaluru.png" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Bengaluru, Karnataka</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>Public Works Department, Karnataka;</span></h4>
                      <h4>Ended Nov, 2018</h4>
                  </div>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The project is a medical college building in Shivaji nagar, Bengaluru with a temperate climate.
                        It is a daytime building that functions for 12 hours a day. 
                        IDSPL provided recommendations and implementation of interventions to be adopted in the demonstration 
                        building to achieve ECBC compliance  related to envelope optimisation, cooling load reduction, 
                        HVAC DBR peer review, Renewable energy systems, building energy analysis etc.
                      </p>
