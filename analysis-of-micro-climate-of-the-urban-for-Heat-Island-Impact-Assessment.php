...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Analysis of microclimate of the urban forms in New Delhi for Urban Heat Island Impact Assessment</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Analysis of microclimate of the urban forms in New Delhi for Urban Heat Island Impact Assessment</h4>
                <p>Urban UHI Assessment</p>
            </div>
        </div>
      </section>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/micro-climate-impact-assessment.png" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>New Delhi</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>SPA Delhi;</span></h4>
                      <h4>Ended 2023</h4>
                  </div>
                  <div class="peopleInvolved">
                      ...
                      <ul>
                        ...
                        <li title="Naga Venkata Sai Kumar"><img src="./images/naga2.jpg" alt="" class="img-circle" /></li>
                  ...
                  <div class="individualPortfolioDes">
                        ...
                        <div style="margin-top:30px;margin-bottom: 30px;">
                            ...
                            <ul style="margin-left: 30px; padding:4px;">
                                <li><a href="http://spa.ac.in/Home.aspx?ReturnUrl=%2f"  target="_blank">SPA</a></li>
                            </ul>
                        </div>  
                  </div>
