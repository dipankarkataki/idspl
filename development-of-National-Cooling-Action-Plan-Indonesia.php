...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Development of National Cooling Action Plan for Indonesia</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Development of National Cooling Action Plan for Indonesia</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/national-cooling-indonesia.png" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Indonesia</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                  ...
                  <div class="hashtags">
                    ...
                    <p>Indonesia</p>
                    <p>Policy</p>
                    <p>Cooling Action Plan</p>
                  </div>
                  <div class="individualPortfolioDes">
                    <p>
                        Assessment of cooling demand, energy demand, direct emissions and indirect emissions from the Building Space Cooling, Mobile Air Conditioning, Food Cold Chain sectors of Indonesia. 
                        Technical support in preparation of interventions and recommendations for the development of national cooling action plan.
                    </p>
