		   ...
		   <div class="col-sm-6">
             <nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Tanu Lodhi</li>
			  </ol>
			 </nav>
			</div>
			<div class="col-sm-6">
				...
				<div class="row d-print-table-row">
					<div class="col-xs-12 col-sm-5 col-md-3 d-print-table-cell">
						<div class="members_info">
							<div class="member">
								<img src="./images/tanu.jpg" alt="" class="img-rounded" />
								<h4>Tanu Lodhi</h4>
								<h5>UI/UX Expert</h5>
							</div>
					...
					<div class="col-xs-12 col-sm-7 col-md-9 d-print-table-cell">
						<div class="m_project_details">
							<div class="member_desc">
								<p>Tanu Lodhi is a graduate in computer science engineering. Very passionate and interested in Computer Languages since graduation. She wanted to design a website then started digging deep into the IT where she got to know about  website development, Strong knowledge of Front-End and Back-end, Basic scripting languages like HTML, CSS, JS, Angular and Programming Languages Like C, C++. By the end of her graduation, she got hands-on experience of dynamic web application development.<span id="dots">...</span></p>
								<div id="more">
								    <p>After her graduation, she joined IDSPL as a  trainee where she brushed her skills as per the requirement of the IT Industry. she have very good knowledge of both Front-End and Back-End Developent, Website and database connectivity.</p>
								</div>
