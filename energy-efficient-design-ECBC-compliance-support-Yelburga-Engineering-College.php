...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Energy Efficient Design & ECBC Compliance Support for Yelburga Engineering College</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Energy Efficient Design & ECBC Compliance Support for Yelburga Engineering College</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/yelburga-college.png" /></li>
                </ul>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The Public Works Department (PWD), Karnataka have proposed the Government Engineering College
                        in Talakalla, Yelburga Taluk in Koppal district of Karnataka. The college has Ground+3 floors.
                        The building is being designed for the higher education in engineering discipline, with four
                        courses having advanced facilities. IDSPL provided recommendations and implementation of interventions
                        to be adopted in the demonstration building to achieve ECBC compliance  related to envelope optimisation,
                        cooling load reduction, HVAC DBR peer review, Renewable energy systems, building energy analysis etc.
                      </p>
