...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>HVAC Plant Automation System (IBEMS)</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>HVAC Plant Automation System (IBEMS)</h4>
                <p>Products</p>
            </div>
        </div>
      </section>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/ibems.png" /></li>
                </ul>
                ...
                <div class="hashtags">
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The wireless automation system has temperature sensors, filter monitoring,
                        actuator sensors and control, VFD status and control, damper control and trip status.
                        It also has BTU sensors, integrated BTU meters, and static pressure sensors. One-stop
                        solution for control of water-side and air-side system in commercial and residential
                        building with centralized air conditioning systems.
                      </p>
