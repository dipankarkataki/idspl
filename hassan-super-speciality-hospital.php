...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Hassan Super Speciality Hospital Energy Efficient Design</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Hassan Super Speciality Hospital Energy Efficient Design</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/hasan-hospital.png" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Hassan, Karnataka</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The project is a 24 hours super speciality hospital building located in Hassan, 
                        Karnataka which comes under a warm and humid climate zone. IDSPL provided recommendations
                        and implementation of interventions to be adopted in the demonstration building to achieve
                        ECBC compliance  related to envelope optimisation, cooling load reduction, HVAC DBR peer review,
                        Renewable energy systems, building energy analysis etc.
                      </p>
