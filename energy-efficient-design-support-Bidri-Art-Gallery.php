...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Energy Efficient Design Support for Bidri Art Gallery</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Energy Efficient Design Support for Bidri Art Gallery</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/bidri-art-gallery.png" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Bidar, Karnataka</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                  ...
                  <div class="hashtags">
                    <p>Mixed Use Building</p>
                    <p>Building Energy Efficicency</p>
                    <p>ECBC Compliance</p>
                    <p>ECBC</p>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The project is a mixed-use building which satisfies the ECBC compliance requirement. The building has basement, ground + 3 floors. 3 cases (PWD Case, Base case and Proposed case) were analysed for different building configuration and it’s usages.
                        IDSPL provided technical consulting related to envelope optimisation, cooling load reduction, HVAC DBR peer review, Renewable energy systems, building energy analysis etc.
                      </p>

                    <div style="margin-top:30px;margin-bottom: 30px;">
                      <h5 style="margin-bottom:10px;font-weight:600;">Relevant Links</h5>
                      <ul style="margin-left: 30px; padding:4px;">
                        <li><a href="https://bidar.nic.in/en/handicraft/"  target="_blank">Bidar Art Gallery</a></li>
                      </ul>
                    </div>  
                  </div>
