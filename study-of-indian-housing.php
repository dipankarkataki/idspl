...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Study of the Indian housing market and the impacts of energy efficiency measures</title>
          ...
          <div class="container">
              <div class="secondaryHeaderContent portfolioSecondaryHeader">
                 <a href="./portfolio.php"> <img src="./images/backButton.svg"/></a>
                  <h4>Study of the Indian housing market and the impacts of energy efficiency measures</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                  ...
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>Adelphi Consultation GmbH;</span></h4>
                  </div>
                  <!-- <div class="hashtags">
                    <p>LEED</p>
                    <p>LEED Platinum</p>
                  ...
                  <div class="individualPortfolioDes">
                    <p>
                        Study of the Indian housing market and the impacts of energy efficiency measures for the 
                        Credit Line from KFW for Indian Housing Energy Efficiency.
                        The activities of this assignment include desk research, analysis and reporting on:
                        <ul style="list-style-type:circle;">
                            <li>Overview of Indian housing market.</li>
                            <li>Comparing green/EE building certificates.</li>
                            <li>Incremental costs.</li>
                            <li>Minimum EE requirements and targets.</li>
                            <li>Target group analysis.</li>
                            <li>Future consulting support.</li>
      ...
      <section class="portfolionav">
          <div class="container">
            <div class="portfolionav">
                ...
                <div class="portfolionavList">
                  <a class="next-link" href="new-un-extension-office.php">
