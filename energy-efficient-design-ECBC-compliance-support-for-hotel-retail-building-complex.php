...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Energy Efficient Design & ECBC Compliance Support for Hotel & Retail Building Complex</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Energy Efficient Design & ECBC Compliance Support for Hotel & Retail Building Complex</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/calicut-hotel.png" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Calicut, Kozhikode</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>Public Works Department, Kerala;</span></h4>
                      <h4>Ended Jun, 2018</h4>
                  </div>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The project is a hotel building located in Kozhikode, Kerala with warm and humid ckimate. The building has ground+10 floors and basement with retail spaces, hotel rooms, fitness centres, parking and other spaces.
                        IDSPL provided recommendations and implementation of interventions to be adopted in the demonstration building to achieve ECBC compliance  related to envelope optimisation, cooling load reduction, HVAC DBR peer review, Renewable energy systems, building energy analysis etc.        
                      </p>
