...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>Energy Audit Survey of Chief Secretariat</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Energy Audit Survey of Chief Secretariat</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/cheif-secreteriat.jpg" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>Puducherry</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                  ...
                  <div class="peopleInvolved">
                      ...
                      <ul>
                        ...
                        <li title="Ranjith AR"><img src="./images/ranjith.jpg" alt="" class="img-circle" /></li>
                      </ul>
                  </div>
                  <div class="hashtags">
                    <p>Energy Audit</p>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The walk-through energy audit was conducted for the chief secretariat building
                        in Puducherry for achieving BEE 5 Star rating  for existing office building.
                        The project involved detailed analysis of energy use.  The potential energy 
                        conservation measures were detailed which can save energy up to 40% of total consumption. 
                      </p>
