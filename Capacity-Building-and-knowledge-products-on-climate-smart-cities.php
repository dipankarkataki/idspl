...
<html lang="en" dir="ltr">
  <head>
      ...
      <title>Portfolio - Capacity Building and knowledge products on climate smart cities</title>
          ...
          <div class="container">
              <div class="secondaryHeaderContent portfolioSecondaryHeader">
                 <a href="./portfolio.php"> <img src="./images/backButton.svg"/></a>
                  <h4>Capacity Building and knowledge products on climate smart cities</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                  ...
                  <div class="individualPortfolioDes">
                    <p>
                        NIUA aimed for the capacity building of the Smart City SPVs, PMC, Engineering and Public Works Department officials, the ULB, water department and development authority officials in order to build the capacities of Smart Cities to understand and perform better on the CSCAF indicators.
                        IDSPL developed 3 training sessions, presentation, Training manuals, ToT manuals on controlling  per capita "Fossil fuel consumption in the city" and "energy efficient water supply system”. The team also provided training workshops for the stakeholders.
                        The training manuals on "Fossil fuel consumption in the city" and "energy efficient water supply system” have been published by NIUA.
                    </p>
