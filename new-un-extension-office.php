...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>New UN Extension (Annexe) office in New Delhi a Near Zero Energy Building</title>
          ...
          <div class="container">
              <div class="secondaryHeaderContent portfolioSecondaryHeader">
                 <a href="./portfolio.php"> <img src="./images/backButton.svg"/></a>
                  <h4>New UN Extension (Annexe) office in New Delhi a Near Zero Energy Building</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                  ...
                  <div class="individualPortfolioDes">
                    <p>
                        The project was implemented to make the new UN Extension (Annexe) office in New Delhi a Near Zero Energy Building.
                        Description of actual services provided by your staff within the assignment:
                        Work involves technical consulting for 
                        <ul style="list-style-type:circle;">
                            <li>1,000 m2 of new annexe building to make it net zero energy building.</li>
                            <li>Deep retrofitting of UN House in Delhi through integration of energy efficiency and 
                                renewable energy interventions. Energy efficiency interventions include proposals for 
                                building envelope, lighting, HVAC and electrical systems. It is estimated that through 
                                implementation of energy efficiency interventions, the energy use intensity will reduce 
                                from 190 kWh/m2.year to 90 kWh/m2.year. Solar PV of 130 kWp capacity has been also 
                                proposed on RESCO model.
                            </li>
                        </ul>
          ...
          <div class="container">
            <div class="portfolionav">
                <div class="portfolionavList">
                  <a class="prev-link" href="study-of-indian-housing.php">
                    <h5><img src="./images/arrow-left.svg" alt=""> Previous Work</h5>
                    <h4>Study of the Indian housing market and the impacts of energy efficiency</h4>
                  </a>
                </div>
                <div class="portfolionavList">
                  <a class="next-link" href="greentech-knowledge-solution-pvt-ltd.php">
