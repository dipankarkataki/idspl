...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>International Standard BMS Design Compliance & Installation Support</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>International Standard BMS Design Compliance & Installation Support</h4>
                <p>Products</p>
            </div>
        </div>
      </section>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/bms-design.png" /></li>
                </ul>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The BMS design is end to end encrypted. The customised dashboards are the best fit for the devices.
                        It has access to both web and mobile devices. It eensures that the data integrates into the business,
                        so that the operations remain lean and green. The systems analyzes the  data to create the right processes
                        and building functionalities that set the precedent for preventive maintenance. 
                      </p>
