...
<html lang="en" dir="ltr">
  <head>
      ...
      <title>Portfolio - >CoolR and Comfort-IDS</title>
		   ...
		   <div class="col-sm-6">
             <nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
				...
				<!--<li class="breadcrumb-item active"> CoolR and Comfort-IDS</li>-->
			  </ol>
			 </nav>
			</div>
			<div class="col-sm-6">
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                  <ul class="slider-ul project-img-list">
                    <li class="slider-item"><img src="./images/coolr-comfort-ids1.jpg" /></li>
                    <li class="slider-item"><img src="./images/coolr-comfort-ids2.jpg" /></li>
                    <li class="slider-item"><img src="./images/coolr-comfort-ids3.jpg" /></li>
                  </ul>
                  <div class="individualPortfolioDetails">
                      <h4>CLient : <span>Self-initiative;</span></h4>
                      <h4>January 2017 onwards</h4>
                  </div>
                  <div class="individualPortfolioDes">
                    <p>I-COOLR is a non-refrigerant based air conditioning system that can accomplish thermal comfort needs of occupants in the buildings at low energy consumption, equipped with climate oriented electronic control system called COMFORT-IDS.</p>
                    <p>The project aims to establish low cost and energy efficient technology for the residential building sector, mainly for the affordable housing sector. The technology enabled with human-centric controls engages occupant to operate efficiently. The rooftop system can integrate with Solar PV to function at the times of peak demand or power cuts from utilities.</p>
                  </div>
              </div>
          </div>
      </section>
          ...
          <div class="container">
            <div class="portfolionav">
                <div class="portfolionavList">
                  <a class="prev-link" href="isee.php">
                ...
                <div class="portfolionavList">
                  <a class="next-link" href="knowledge-dissemination.php">
                    <h5>Next Work <img src="./images/arrow-right.svg" alt=""></h5>
                    <h4>Knowledge Dissemination
