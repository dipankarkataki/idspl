...
<html lang="en" dir="ltr">
  <head>
      ...
      <meta name="keywords" content="">
       <title>National Hospital Survey</title>
      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>National Hospital Survey</h4>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/hospital-survey.png" /></li>
                </ul>
                  <div class="individualPortfolioDetails">
                      <h4> <i class="fa fa-map-marker"></i> : <span>India</span></h4>
                  </div>
                  <div class="individualPortfolioDetails">
                      <h4>Client : <span>CCDC;</span></h4>
                      <h4>Ended Dec, 2022</h4>
                  </div>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        Centre for Chronic Disease intended to conduct energy surveys in both public and private hospitals with three objectives to map the energy footprint of Indian Healthcare System, to assess the state of renewable energy deployment in healthcare and its potential to impact healthcare delivery and lastly, to establish a strategy to drive enhanced uptake of renewables in healthcare. 
                        IDSPL conducted the hospital survey in approx 100 hospitals comprised of 20 data points for private and public hospital mapping business & operational details, operational energy use, equipment asset information and bio- medical equipment use in the healthcare facilities. 
                        The survey details are being analysed in the framework created by CCDC and AEEE. The ouput will be put in the report for sharing it with states and private hospital chains.
                      </p>
