      ...
      <section class="secondaryHeader">
        <div class="container">
            <div class="secondaryHeaderContent portfolioSecondaryHeader">
                ...
                <h4>Air Quality Monitoring & Management System</h4>
                <p>Products</p>
            </div>
        </div>
      </section>
          ...
          <div class="container">
              <div class="individualPortfolioImage">
                <ul class="slider-ul project-img-list">
                  <li class="slider-item"><img src="./images/air-quality.png" /></li>
                </ul>
                  ...
                  <div class="individualPortfolioDes">
                      <p>
                        The indoor air quality monitoring system has sensors like temperature sensor, room pressure sensor, humidity sensor, carbon monoxide and carbon-di-oxide sensor, particulate matter sensor and Volatile organic compound sensor.  
                        These sensors help on maintain temperature,  senses and alerts for fie breaks, maintains humidity, ventilation and exhaust systems. It creates alerts when exceeds threshold limits. 
                      </p>
